...
// Класс для получения котофакта с веб-сервиса
...
public class WebApiCatFacts {
    ...
    /*
    Работа с Web API:
    HTTP-запрос к https://catfact.ninja/fact
    Метод делает HTTP-запрос к API и парсит ответ.
     */
    ...
    /*
    Сохранение котофактов в файлы:
    Факты сохраняются в двоичном формате и в формате JSON.
     */
