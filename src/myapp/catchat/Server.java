...
public class Server {
    ...
    public static void main(String[] args) {
        ClientStarter.start();
        /*
        Обработка нескольких клиентских подключений:
        Сервер использует ServerSocket для прослушивания входящих соединений на порту 8080.
        Для каждого нового клиента создается отдельный поток ServerThread, который обрабатывает сообщения от клиента.
        Используется ExecutorService для управления потоками.
         */
