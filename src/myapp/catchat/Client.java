...
public class Client {
    ...
    public static void startClient() {
        /*
         ...
         Клиент подключается к серверу с помощью Socket
         и обменивается сообщениями через потоки ввода-вывода.
         */
        try (Socket socket = new Socket(HOST, PORT);
            ...
            Клиент использует потоки ReadMsg и WriteMsg
            для чтения и отправки сообщений.
             */
